...
/* ============================================================
   USERS REPORT
============================================================ */
router.get("/users.csv", (0, auth_1.requirePermission)("audit.read"), async (_req, res, next) => {
    try {
...
/* ============================================================
   AUDIT LOGS REPORT
============================================================ */
router.get("/audit.csv", (0, auth_1.requirePermission)("audit.read"), async (_req, res, next) => {
    try {
...
============================================================ */
router.get("/security.csv", (0, auth_1.requirePermission)("audit.read"), async (_req, res, next) => {
    try {
...
============================================================ */
router.get("/import.csv", (0, auth_1.requirePermission)("audit.read"), async (_req, res, next) => {
    try {
        const events = await prisma.metricEvent.findMany({
            where: {
                OR: [
...
/* ============================================================
   ALL METRICS REPORT
============================================================ */
router.get("/metrics.csv", (0, auth_1.requirePermission)("audit.read"), async (_req, res, next) => {
    try {
        const events = await prisma.metricEvent.findMany({
            orderBy: { createdAt: "desc" }
        });
